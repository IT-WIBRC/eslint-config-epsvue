...
const config = require("../../stylelint/index.js");

describe("With css file", () => {
  const validCss = readFileSync("./__tests__/stylelint/valid.css", "utf-8");
  const invalidCss = readFileSync("./__tests__/stylelint/invalid.css", "utf-8");
