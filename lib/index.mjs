...
let vueEslintConfigTypescriptRecommendedTypeChecked = null;
 if (vueEslintConfigTypescript) {
  vueEslintConfigTypescriptRecommendedTypeChecked =  vueEslintConfigTypescript
  .defineConfigWithVueTs(
    vueEslintConfigTypescript.vueTsConfigs.recommendedTypeChecked
  );
 }
...
export default [
  ...
  ...(vueEslintConfigTypescriptRecommendedTypeChecked ?? {}),
  {
    files: ["**/*.ts", "**/*.tsx", "**/*.mts"],
    rules: {
